...
<table class="slvideo">
  ...
  <tr>
    <td>
      <iframe width="420" height="315"
        src="https://www.youtube.com/embed/oyFf3t91t1w"
        frameborder="0" allowfullscreen>
      </iframe>
    </td>
    <td class="slvideo-desc">
      <h3>21st Avenue Christmas Tree Rezzing, November 24, 2007</h3>
      Just like the city of Portland, Oregon (where the real 21st
      Avenue exists) lights a Christmas Tree before the holidays,
      the 21st Avenue sim held their own Christmas tree rezzing
      party.
    </td>
  </tr>
  <tr>
    <td>
      <iframe width="420" height="315"
        src="https://www.youtube.com/embed/R25kP00G-rA"
        frameborder="0" allowfullscreen>
      </iframe>
    </td>
    <td class="slvideo-desc">
      <h3>Portland Connection Grand Opening Dance, September 7, 2008</h3>
      The official opening of the Portland Connection [SecondLife] region
      was celebrated by a day-long party.
      This video captures many of the celebrants and some of the dancing
      as well as providing a tour of the region.
      Music by Rosedrop Rush and Grif Bamaisin.
      party.
    </td>
  </tr>
  <tr>
    <td>
      <iframe width="420" height="315"
        src="https://www.youtube.com/embed/G3wrulnj5N8"
        frameborder="0" allowfullscreen>
      </iframe>
    </td>
    <td class="slvideo-desc">
      <h3>Dancing in Pioneer Courthouse Square, August 3, 2008</h3>
      The Portland Connection sim included a mirror of the 
      [Pioneer Courthouse Square]
      that is in downtown Portland Oregon.
      This is a video of one of the many dances held there.
      Music by Grif Bamaisin.
    </td>
  </tr>
  <tr>
    <td>
      <iframe width="420" height="315"
        src="https://www.youtube.com/embed/tVsVK6Ez5YE"
        frameborder="0" allowfullscreen>
      </iframe>
    </td>
    <td class="slvideo-desc">
      <h3>Thursday Dance with DJ6, October 1, 2009</h3>
      The Portland Connection sim held weekly Thursday dances
      where the locals and not so local would come in their
      [SecondLife] personas to dance and chat.
      This dance was hosted by the in-world DJ "DJ6".
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td class="slvideo-desc">
      <h3>St Patricks Day Party, March 2010</h3>
      The St Patricks Day Party held at the
      "Bridge 27" pub in the [SecondLife] Portland Connection sim.
      Music by Grif Bamaisin.
    </td>
  </tr>
</table>
